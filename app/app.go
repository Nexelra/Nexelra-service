...
import (
    ...
    identitymodulekeeper "Nexelra/x/identity/keeper"
    appante "Nexelra/app/ante"                     
...
func (app *App) setAnteHandler() {
    ...
    // Debug log để confirm ante handler được set
    fmt.Println("🔥 ANTE HANDLER SET SUCCESSFULLY IN APP")
}
